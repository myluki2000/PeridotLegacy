    ...
    public class RectCollider : ICollider
    {
        ...
        public void Draw(SpriteBatch sb, Camera camera, Color color, bool drawDragPoints)
        {
            ...
            if (drawDragPoints)
            {
                ...
                // upper right
                Utility.DrawRectangle(sb, new Rectangle(Rect.X + Rect.Width - DRAG_POINT_SIZE, Rect.Y, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);

                // lower left
                Utility.DrawRectangle(sb, new Rectangle(Rect.X, Rect.Y + Rect.Height - DRAG_POINT_SIZE, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);

                // lower right
                Utility.DrawRectangle(sb, new Rectangle(Rect.X + Rect.Width - DRAG_POINT_SIZE, Rect.Y + Rect.Height - DRAG_POINT_SIZE, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);
            }
        }
