...
namespace PeridotEngine.Engine.World.Physics.Colliders
{
    class QuadCollider : ICollider
    {
        ...
        public void Draw(SpriteBatch sb, Camera camera, Color color, bool drawDragPoints)
        {
            ...
            {
                // upper left
                Utility.Utility.DrawRectangle(sb, new Rectangle((int)Point4.X, (int)Point4.Y, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);

                // upper right
                Utility.Utility.DrawRectangle(sb, new Rectangle((int)Point3.X - DRAG_POINT_SIZE, (int)Point3.Y, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);

                // lower left
                Utility.Utility.DrawRectangle(sb, new Rectangle((int)Point1.X, (int)Point1.Y - DRAG_POINT_SIZE, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);

                // lower right
                Utility.Utility.DrawRectangle(sb, new Rectangle((int)Point2.X - DRAG_POINT_SIZE, (int)Point2.Y - DRAG_POINT_SIZE, DRAG_POINT_SIZE, DRAG_POINT_SIZE), color);
            }
        }
