...
using PeridotEngine.Engine.UI.DevConsole.Commands;

namespace PeridotEngine.Engine.UI.DevConsole
{
    class DevConsole
    {
        ...
        public void Draw(SpriteBatch sb)
        {
            if (IsVisible)
            {
                ...
                Utility.Utility.DrawRectangle(sb, new Rectangle(0, 0, Globals.Graphics.PreferredBackBufferWidth, Globals.Graphics.PreferredBackBufferHeight / 2), new Color(110, 110, 110, 200));

                // input box background
                Utility.Utility.DrawRectangle(sb, new Rectangle(0, Globals.Graphics.PreferredBackBufferHeight / 2, Globals.Graphics.PreferredBackBufferWidth, 30), new Color(70, 70, 70, 200));
